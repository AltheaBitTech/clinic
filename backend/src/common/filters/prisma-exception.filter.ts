...
function extractConflictFields(exception: Prisma.PrismaClientKnownRequestError): string[] {
...
export class PrismaExceptionFilter implements ExceptionFilter {
  ...
  private toHttpException(exception: Prisma.PrismaClientKnownRequestError): HttpException {
    switch (exception.code) {
      ...
      case 'P2003': {
        const field = (exception.meta as Record<string, any> | undefined)?.field_name as string | undefined;
      ...
      default:
        return new BadRequestException('The request could not be processed due to a database error.');
    }
  }
}
